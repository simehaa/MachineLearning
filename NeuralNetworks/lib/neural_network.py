...
class NeuralNetwork:
    ...
    def SGD(self, X, y, layers, cost, epochs=50, batch_size=100, eta=0.01, reg=1e-6):
        ...
        for e in range(epochs):
            ...
            # <<< Backpropagation
            self.vali_accuracy[e] = (
                np.sum(self.predict(X_vali) == y_vali) / y_vali.shape[0]
            )
...
class NeuralNetworkRegr:
    ...
    def SGD(self, X, y, epochs=50, batch_size=100, eta=0.01, reg=1e-6):
        """
        Info
